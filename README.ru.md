...
Подробные заметки к каждому релизу — отдельные файлы `RELEASE_NOTES_X.Y.Z.md` в корне репозитория.
...
Подробности — [`RELEASE_NOTES_1.1.0.md`](RELEASE_NOTES_1.1.0.md).
...
Подробности — [`RELEASE_NOTES_1.0.2.md`](RELEASE_NOTES_1.0.2.md).
...
Подробности — [`RELEASE_NOTES_1.0.1.md`](RELEASE_NOTES_1.0.1.md) (файл
